...
UUID=${UUID:-'de04add9-5c65-2bab-950c-08cd5120df59'}
VMESS_WSPATH=${VMESS_WSPATH:-'/share'}
VLESS_WSPATH=${VLESS_WSPATH:-'/vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/share'}
...
wget https://github.com/hy817120/xray-paas/blob/main/mikutap.zip -O /usr/share/nginx/mikutap.zip
